    ...
    <div className="h-screen w-full flex overflow-hidden bg-white font-sans selection:bg-brand-500/10">
      ...
      <div className="hidden lg:flex flex-1 flex-col justify-between p-16 bg-slate-900 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-sm">
           <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-white font-bold text-[10px] uppercase tracking-widest mb-6">
           ...
           <p className="text-lg text-slate-400 font-medium leading-relaxed">
             Join thousands of users who use our tools to scale their digital presence every day.
           </p>
        </div>

        <div className="relative z-10">
           <p className="text-[10px] font-bold text-slate-700 uppercase tracking-widest">Global Access / 2026</p>
        </div>
      ...
      {/* Right Panel: Form */}
      <div className="flex-1 flex flex-col justify-center items-center p-8 sm:p-12 relative overflow-y-auto subtle-scrollbar">
        <div className="w-full max-w-sm space-y-8 my-auto">
          ...
          <div className="space-y-1">
             ...
             <p className="text-slate-500 text-sm font-medium">Join our community and start growing today.</p>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <button 
               type="submit" 
               disabled={isLoading}
               className="w-full h-12 bg-slate-900 hover:bg-slate-800 text-white font-bold text-sm rounded-xl shadow-lg shadow-slate-900/10 transition-all hover:scale-[1.01] active:scale-[0.99] disabled:opacity-50 flex items-center justify-center gap-2 mt-4"
            >
               {isLoading ? (
          ...
          <p className="text-center text-xs font-bold text-slate-400">
             Already have an account? <Link href="/login" className="text-slate-900 hover:underline">Sign in here</Link>
          </p>
        </div>
